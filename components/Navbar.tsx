...
const Navbar = () => {
  ...
  return (
    <div className='flex flex-row sticky top-0 z-50 bg-white w-full px-6 lg:px-20 py-4 border-b items-center select-none justify-between truncate'>
        ...
        <Link href='/'>
          <div className='flex flex-row items-center cursor-pointer'>
            <svg
              ...
              viewBox='0 0 24 24'
              fill='currentColor'
              className='w-8 h-8 text-mcgill mr-4 md:mr-2'
            >
