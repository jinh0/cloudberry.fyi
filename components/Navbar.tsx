...
const Navbar = () => {
  ...
  return (
    <div className='flex flex-row sticky top-0 z-50 bg-white w-full px-6 lg:px-20 py-3 border-b items-center select-none justify-between truncate transition-all'>
